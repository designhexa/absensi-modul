...
export const SEED_PRODUK: Produk[] = [
  ...
  { id: "b-cuppud01", nama: "Cup Puding", harga: 0, satuan: "pcs" },
  { id: "b-ttoat01", nama: "Tutup Oat", harga: 0, satuan: "pcs" }
];
...
export const SEED_USERS: UserAccount[] = [
  ...
  { username: "tl", password: "tl123", nama: "Tim Leader", role: "tl", karyawanId: "k-tl" },
  ...SEED_OUTLETS.map((o) => {
...
const RAW_BAHAN = [
  ...
  { kode: "PUD01", nama: "PUDING", satuan: "pcs", stokMin: 5, stokAwal: 34, hargaBeli: 10000, konversiGram: 130 },
  { kode: "OAT01", nama: "OAT", satuan: "pcs", stokMin: 5, stokAwal: 25, hargaBeli: 10000, konversiGram: 180 },
  { kode: "CB01", nama: "CUP BUBUR", satuan: "pcs", stokMin: 200, stokAwal: 1865, hargaBeli: 530 },
  { kode: "TTP01", nama: "TUTUP", satuan: "pcs", stokMin: 200, stokAwal: 0, hargaBeli: 200 },
  { kode: "TTOAT01", nama: "TUTUP OAT", satuan: "pcs", stokMin: 50, stokAwal: 1000, hargaBeli: 200 },
