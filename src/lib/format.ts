...
// Tanggal lokal (bukan UTC) — penting untuk WIB (UTC+7): toISOString() bisa mundur 1 hari
// sebelum jam 07:00 pagi. Offset negatif dibalik karena getTimezoneOffset = UTC - lokal.
